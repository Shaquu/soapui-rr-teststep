...
public class RRTestStep extends WsdlTestStepWithProperties implements PropertyExpansionContainer
{
    ...
    protected RRTestStep(WsdlTestCase testCase, TestStepConfig config, boolean forLoadTest )
    {
        super( testCase, config, true, forLoadTest );

        if( !forLoadTest )
        {
            setIcon( UISupport.createImageIcon( RRTestStepFactory.defaultIconPath ) );
        }
